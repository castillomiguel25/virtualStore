            ...
            <figure className='relative'>
              ...
              {isHovered && (
                <button
                  ...
                  bg-gradient-to-r from-indigo-500 to-indigo-600 rounded-md shadow-md hover:bg-indigo-600 focus:outline-none
                  focus:ring-2 focus:ring-indigo-500 dark:bg-gradient-to-r dark:from-emerald-500 dark:to-emerald-600 dark:text-white`}
