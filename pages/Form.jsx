      ...
      <form className="max-w-md mx-auto p-6 bg-white dark:bg-gray-800 shadow-md rounded-md mt-10 border">
        <div className="mb-4">
          ...
          <input
            type="text"
            id="nombre"
            className="w-full px-3 py-2 placeholder-gray-400 border rounded-md dark:bg-gray-700 dark:text-white"
        ...
        <div className="mb-4">
          ...
          <textarea
            id="mensaje"
            className="w-full px-3 py-2 placeholder-gray-400 border rounded-md resize-none dark:bg-gray-700 dark:text-white"
            rows="4"
        ...
        <button
          type="submit"
          className="w-full py-2 px-4 text-white bg-indigo-500 rounded-md hover:bg-indigo-600"
        >
          Enviar
        </button>
      </form>
